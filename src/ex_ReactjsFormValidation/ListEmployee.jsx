...
export default function ListEmployee(props) {
  ...
  const listEmployee = useSelector(
    (state) => state.manageEmployeeSlice.listArr,
  );
    ...
    <section className="bg-gray-50 dark:bg-gray-900 py-5 sm:py-16">
      <div className="mx-auto max-w-screen-xl lg:px-12">
        ...
        <div className="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg">
          ...
          <nav
            className="flex flex-col md:flex-row justify-between items-start gap-1 md:items-center space-y-3 md:space-y-0 p-4"
